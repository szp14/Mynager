...
function checkUsername() {
    /*if (checkNotEmpty('usernameGroup', 'helpUsername', 'inputUsername', 'Mynager账号')) {
        return checkIsDigit('usernameGroup', 'helpUsername', 'inputUsername', 'Mynager学号');
    }*/
    return checkNotEmpty('usernameGroup', 'helpUsername', 'inputUsername', 'Mynager账号');
}
