...
ALLOWED_HOSTS = ['139.196.113.225']

BROKER_URL = 'django://'
CELERYD_LOG_FILE= os.path.join(BASE_DIR, 'worker.log')
CELERYBEAT_LOG_FILE = os.path.join(BASE_DIR, 'beat.log')
...
WSGI_APPLICATION = 'Mynager.wsgi.application'
